...
const Aside = styled.aside<{ $opened: boolean }>`
  ...
  transform: translateX(
    ${(props) => (props.$opened ? "none" : `-${asideWidth}px`)}
  );
  ...
  return (
    <>
      <Aside $opened={aside}>
          ...
          <li>
            <a href="#">
              <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                <path d="M148,156a64,64,0,0,0,0-128H88A12.0006,12.0006,0,0,0,76,40v92H56a12,12,0,0,0,0,24H76v16H56a12,12,0,0,0,0,24H76v20a12,12,0,0,0,24,0V196h44a12,12,0,0,0,0-24H100V156ZM100,52h48a40,40,0,0,1,0,80H100Z" />
              </svg>
              Цены на металл
            </a>
          </li>
        ...
        <AsideItem>
          <BtnIcon
            areaLabel="Смена цвета темы"
            classname={`switchIcon ${theme ? "active" : ""}`}
            handler={() => toggleTheme()}
          />
        </AsideItem>
      </Aside>
